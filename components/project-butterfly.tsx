      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-12 lg:py-16">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-12">
          <div className="text-right space-y-4">
            <p className="text-lg text-muted-foreground leading-relaxed">The Butterfly كمبوند سكني راقٍ من مدينة مصر في مدينة المستقبل على ٢٨٨ فداناً أمام سراي مباشرةً. يتميز بالمساحات الخضراء الواسعة وبحيرات مائية تغطي الجزء الأكبر من المشروع. خيار مثالي لمن يبحث عن خصوصية وطبيعة داخل مجتمع سكني متكامل.</p>
          ...
          <div className="space-y-0">
            {[
              ...
              { label: "الأسعار", value: "تبدأ من ٧ مليون جنيه" },
            ].map((item, i) => (
